                    ...
                    foreach($video['Media'] as $media) {
                        if ($media['@attributes']['selected'] === '1') {
                            ...
                            $mergedStream = [
                                ...
                                'duration' => $duration,
                                'artUrl' => '/plugins/jdownloaderstatus/getImage.php?img=' . urlencode($artThumb) . '&host=' . urlencode($streams['@host']),
                                'thumbUrl' => '/plugins/jdownloaderstatus/getImage.php?img=' .  urlencode($video['@attributes']['grandparentThumb'] ?? $video['@attributes']['thumb']) . '&host=' . urlencode($streams['@host']),
                            ...
                            foreach ($part['Stream'] as $stream) {
                                if ($stream['@attributes']['selected'] === '1') {
                                    ...
                                    $mergedStream = [
                                        ...
                                        'duration' => $duration,
                                        'artUrl' => '/plugins/jdownloaderstatus/getImage.php?img=' . urlencode($audio['@attributes']['art']) . '&host=' . urlencode($streams['@host']),
                                        'thumbUrl' => '/plugins/jdownloaderstatus/getImage.php?img=' .  urlencode($audio['@attributes']['grandparentThumb'] ?? $audio['@attributes']['thumb']) . '&host=' . urlencode($streams['@host']),
